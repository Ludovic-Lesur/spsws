...
typedef enum {
	...
	SI1133_ERROR_BASE_I2C1 = 0x0100,
	SI1133_ERROR_BASE_LPTIM1 = (SI1133_ERROR_BASE_I2C1 + I2C_ERROR_BASE_LAST),
	// Last base value.
	SI1133_ERROR_BASE_LAST = (SI1133_ERROR_BASE_LPTIM1 + LPTIM_ERROR_BASE_LAST)
} SI1133_status_t;
