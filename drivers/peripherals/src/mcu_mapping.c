...
#endif
// SX1232.
const SPI_gpio_t SPI_GPIO_SX1232 = { &GPIO_SPI1_SCK, &GPIO_SPI1_MOSI, &GPIO_SPI1_MISO };
#ifdef HW1_0
...
// MAX11136.
#ifdef HW1_0
const SPI_gpio_t SPI_GPIO_MAX11136 = { &GPIO_SPI1_SCK, &GPIO_SPI1_MOSI, &GPIO_SPI1_MISO };
const GPIO_pin_t GPIO_MAX11136_CS = { GPIOB, 1, 4, 0 };
const GPIO_pin_t GPIO_MAX11136_EOC = { GPIOB, 1, 3, 0 };
#else
const SPI_gpio_t SPI_GPIO_MAX11136 = { &GPIO_SPI2_SCK, &GPIO_SPI2_MOSI, &GPIO_SPI2_MISO };
