...
typedef enum {
	...
	ERROR_BASE_TIM2 = (ERROR_BASE_SPI2 + SPI_ERROR_BASE_LAST),
	...
	ERROR_BASE_RAIN = (ERROR_BASE_NEOM8N + NEOM8N_ERROR_BASE_LAST),
	ERROR_BASE_SHT3X_INT = (ERROR_BASE_RAIN + RAIN_ERROR_BASE_LAST),
